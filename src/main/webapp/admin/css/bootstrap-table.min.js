  ...
  q.DEFAULTS = {
    ...
    if (!(a.inArray(b, this.hiddenRows) > -1)) {
      ...
      return b._data && !a.isEmptyObject(b._data) && a.each(b._data, function (a, b) {
        ...
        var o = "", p = n(b, m, e.options.escape), q = "", r = "", s = {}, t = "", u = e.header.classes[d], v = "",
          w = "", x = "", y = "", z = e.columns[d];
    ...
    var c, d, e, f = b.index, g = a.inArray(b.field, this.getVisibleFields()), h = b.rowspan || 1, i = b.colspan || 1,
      j = this.$body.find(">tr");
